...
use MiLibreria\Exception\ImpossibleMinMaxLimitsException;
use MiLibreria\Exception\InvalidOptionException;
...
class RequirementPasswordGenerator extends ComputerPasswordGenerator
{
     ...
     * @throws \MiLibreria\Exception\CharactersNotFoundException
     */
