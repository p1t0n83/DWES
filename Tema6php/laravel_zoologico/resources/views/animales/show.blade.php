...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p><strong>Fecha de nacimiento:</strong> {{ \Carbon\Carbon::parse($animal['fechaNacimiento'])->format('d-m-Y') }}</p>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6">
            <a href="{{ route('animales.edit', $animal['id']) }}" class="btn btn-primary btn-lg btn-block">Editar</a>
        </div>
    </div>
</div>
@endsection