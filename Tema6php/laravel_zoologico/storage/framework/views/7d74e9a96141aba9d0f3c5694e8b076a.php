...
<?php $__env->startSection('contenido'); ?>
    ...
    <form class="bg-white shadow-md rounded-lg p-6 mb-4" action="<?php echo e(route('animales.update', $animal)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>    
    <div class="mb-4">
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Documents\DWES\Tema6php\laravel_zoologico\resources\views/animales/edit.blade.php ENDPATH**/ ?>